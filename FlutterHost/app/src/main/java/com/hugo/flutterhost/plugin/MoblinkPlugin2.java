 ...
 * MoblinkPlugin
 */
public class MoblinkPlugin2 extends Object implements MethodCallHandler, SceneRestorable {
    ...
    public MoblinkPlugin2(Activity activity) {
    ...
    public static void registerWith(FlutterEngine flutterEngine, Activity activity) {
        ...
        final MethodChannel channel = new MethodChannel(dartExecutor, "com.yoozoo.mob/moblink");
        channel.setMethodCallHandler(new MoblinkPlugin2(activity));
//        MoblinkPlugin2.activity = activity;
        final EventChannel eventChannel = new EventChannel(dartExecutor, EventChannel);
    ...
    public void onMethodCall(MethodCall call, Result result) {
        MobLink.setActivityDelegate(activity, MoblinkPlugin2.this);
        switch (call.method) {
            case getMobId:
